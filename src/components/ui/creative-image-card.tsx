...
function IdleSvgDecorations({ isVisible }: { isVisible: boolean }) {
  return (
    <AnimatePresence>
      {isVisible && (
        <>
          <CornerCircleDecoration position="top-left" delay={0} gradientId="gradient-tl" />
          <CornerCircleDecoration position="top-right" delay={0.1} gradientId="gradient-tr" />
          <CornerCircleDecoration position="bottom-left" delay={0.15} gradientId="gradient-bl" />
          <CornerCircleDecoration position="bottom-right" delay={0.2} gradientId="gradient-br" />
        </>
      )}
    </AnimatePresence>
  )
