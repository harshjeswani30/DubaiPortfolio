...
export function ContactContent() {
  ...
  const features = [
    { icon: <Zap className="h-4 w-4" />, text: "Fast Response" },
    { icon: <Clock className="h-4 w-4" />, text: "24h Reply" },
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            <motion.div
              ...
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#00ADB5]/30 bg-[#00ADB5]/10 px-5 py-2 backdrop-blur-sm"
            >
              <Sparkles className="h-4 w-4 text-[#00ADB5]" />
              <span className="text-sm font-medium text-[#00ADB5]">Let&apos;s Create Together</span>
            </motion.div>
            ...
            <motion.p
              ...
              className="mx-auto mt-6 max-w-xl text-base text-[#EEEEEE]/60 md:text-lg"
            >
            ...
            >
              {features.map((feature, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 rounded-full bg-[#393E46]/50 px-4 py-2 backdrop-blur-sm"
                >
                  <span className="text-[#00ADB5]">{feature.icon}</span>
                  <span className="text-sm text-[#EEEEEE]/70">{feature.text}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
