    ...
    >
      <div className="max-w-3xl space-y-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900/50 p-4">
          <label className="mb-2 block text-sm text-zinc-300">Post JSON</label>
          <textarea
            value={jsonText}
          ...
          <p className="mt-2 text-xs text-zinc-500">
            Tip: ensure <span className="font-mono">slug</span> is unique and set{" "}
            <span className="font-mono">is_published</span> to make it live.
          </p>
        </div>
      </div>
    </AdminShell>
