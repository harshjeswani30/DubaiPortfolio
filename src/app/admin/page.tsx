        ...
        <div className="rounded-2xl border border-[#393E46]/50 bg-[#222831]/80 p-8 backdrop-blur-xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-gradient-to-r from-[#00ADB5] to-[#00ADB5]/80 px-6 py-3 font-semibold text-white transition-all duration-200 hover:shadow-lg hover:shadow-[#00ADB5]/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
...
export default function AdminPage() {
  return (
    <Suspense fallback={
      <div className="flex min-h-screen items-center justify-center bg-[#222831]">
